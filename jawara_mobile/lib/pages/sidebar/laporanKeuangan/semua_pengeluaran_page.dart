  ...
  final List<Map<String, dynamic>> _pengeluaranList = [
    {
      ...
      'jenis': 'Operasional',
      'tanggal': DateTime(2025, 10, 15, 10, 30),
      'nominal': 500000.00,
    },
    {
      'id': 2,
      'nama': 'Pembelian Peralatan',
      'jenis': 'Pengadaan',
      'tanggal': DateTime(2025, 10, 12, 14, 15),
      'nominal': 2500000.00,
    },
    {
      'id': 3,
      'nama': 'Biaya Listrik',
      'jenis': 'Operasional',
      'tanggal': DateTime(2025, 10, 10, 9, 0),
      'nominal': 750000.00,
    },
    {
      'id': 4,
      'nama': 'Gaji Security',
      'jenis': 'Gaji',
      'tanggal': DateTime(2025, 10, 5, 8, 0),
      'nominal': 3000000.00,
    },
  ];
  ...
  void _showDeleteConfirmation(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Apakah Anda yakin ingin menghapus pengeluaran "${item['nama']}"?',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
          ...
          ElevatedButton(
            ...
            onPressed: () {
              Navigator.pop(context);
              setState(() {
                _pengeluaranList.removeWhere((e) => e['id'] == item['id']);
              });
              ScaffoldMessenger.of(context).showSnackBar(
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Pagination
          if (_pengeluaranList.isNotEmpty) _buildPagination(),
        ],
      ),
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Tambah pengeluaran akan segera hadir'),
            ),
          );
        },
        backgroundColor: kPrimaryBlue,
            ...
            children: [
              ...
              TableRow(
                ...
                children: [
                  ...
                  _buildTableHeader('JENIS PENGELUARAN'),
              ...
              // Data rows
              ..._pengeluaranList.asMap().entries.map((entry) {
